...
<table align="center">
  <tr>
    <td><b>Title</b></td>
    <td>n8n + Ollama Local AI Automation Guide</td>
  </tr>
  <tr>
    <td><b>Tags</b></td>
  ...
  <tr>
    <td><b>Languages</b></td>
    <td>English, Bengali, Hindi, Spanish, French, Arabic</td>
  </tr>
</table>
</div>
...
1. Download the <a href="./Ollama_Basic_Workflow.json" download="Ollama_Basic_Workflow.json">[Ollama_Basic_Workflow.json](./Ollama_Basic_Workflow.json)</a> file.
